...
exports.seed = async function(knex) {
  ...
  await knex('photos').insert([
    {id: 1, user_id: 3, prefecture_id: 1, photo_key:'', description: 'A snowy mountain in Niseko'},
    {id: 2, user_id: 3, prefecture_id: 1, photo_key:'', description: 'Beautiful flowers in Furano'},
    ...
    {id: 10, user_id: 4, prefecture_id: 13, photo_key:'', description: 'The statue in Hachiko'},
  ]);
};
